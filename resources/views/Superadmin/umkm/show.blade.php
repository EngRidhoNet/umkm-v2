                ...
                <div class="card-body">
                    <div class="row mb-4">
                        <div class="col-md-4 text-center">
                            <img src="{{ asset('storage/app/public/umkm/foto_profil/' . $umkm->foto_profil) }}" alt="Foto Profil" class="img-fluid rounded-circle mb-3" style="max-width: 200px; height: auto;">
