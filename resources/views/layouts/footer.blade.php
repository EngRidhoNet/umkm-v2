					...
					<div class="row pt-4">
						<div class="col-lg-6">
							<p class="mb-2 text-center text-lg-start">Copyright &copy;<script>
								...
								</script>. All Rights Reserved. &mdash; Designed with love by <a href="https://untreco">Jesica</a> Distributed By <a hreff="https://themewgon.com">Team Pos UMKM</a> <!-- License information: https://untree.co/license/ -->
							</p>
						</div>
