        ...
        <div class="row">
            ...
            <div class="col-md-4 mb-4">
                <div class="card h-100 shadow-sm">
                    ...
                    <div class="card-body">
                        <h5 class="card-title">
                            <a href="{{ route('umkm.artikel.show', $article->id) }}" class="text-decoration-none text-dark">{{ Str::limit($article->judul, 50) }}</a>
                        </h5>
                    ...
                    <div class="card-footer bg-white">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div>
                                <a href="{{ route('umkm.artikel.edit', $article->id) }}" class="btn btn-outline-primary btn-sm me-2">Edit</a>
